...
var file_Trd_ReconfirmOrder_proto_rawDesc = []byte{
	...
	0x32, 0x43, 0x52, 0x03, 0x73, 0x32, 0x63, 0x42, 0x4c, 0x0a, 0x13, 0x63, 0x6f, 0x6d, 0x2e, 0x66,
	0x75, 0x74, 0x75, 0x2e, 0x6f, 0x70, 0x65, 0x6e, 0x61, 0x70, 0x69, 0x2e, 0x70, 0x62, 0x5a, 0x35,
	...
	0x2f, 0x70, 0x62, 0x2f, 0x74, 0x72, 0x64, 0x72, 0x65, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d,
...
func file_Trd_ReconfirmOrder_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_Trd_ReconfirmOrder_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*C2S); i {
			case 0:
				return &v.state
			case 1:
		...
		file_Trd_ReconfirmOrder_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*S2C); i {
			case 0:
				return &v.state
			case 1:
		...
		file_Trd_ReconfirmOrder_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_Trd_ReconfirmOrder_proto_msgTypes[3].Exporter = func(v any, i int) any {
