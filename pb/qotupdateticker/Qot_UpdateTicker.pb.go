...
var file_Qot_UpdateTicker_proto_rawDesc = []byte{
	...
	0x73, 0x32, 0x63, 0x42, 0x4a, 0x0a, 0x13, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x75, 0x74, 0x75, 0x2e,
	0x6f, 0x70, 0x65, 0x6e, 0x61, 0x70, 0x69, 0x2e, 0x70, 0x62, 0x5a, 0x33, 0x67, 0x69, 0x74, 0x68,
	...
	0x71, 0x6f, 0x74, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x74, 0x69, 0x63, 0x6b, 0x65, 0x72,
}
...
func file_Qot_UpdateTicker_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_Qot_UpdateTicker_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*S2C); i {
			case 0:
				return &v.state
			case 1:
		...
		file_Qot_UpdateTicker_proto_msgTypes[1].Exporter = func(v any, i int) any {
