...
func file_Qot_GetUserSecurityGroup_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_Qot_GetUserSecurityGroup_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*C2S); i {
			case 0:
				return &v.state
			case 1:
		...
		file_Qot_GetUserSecurityGroup_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_Qot_GetUserSecurityGroup_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*S2C); i {
			case 0:
				return &v.state
			case 1:
		...
		file_Qot_GetUserSecurityGroup_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_Qot_GetUserSecurityGroup_proto_msgTypes[4].Exporter = func(v any, i int) any {
