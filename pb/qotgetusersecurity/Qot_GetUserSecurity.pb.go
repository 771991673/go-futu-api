...
var file_Qot_GetUserSecurity_proto_rawDesc = []byte{
	...
	0x70, 0x62, 0x2f, 0x71, 0x6f, 0x74, 0x67, 0x65, 0x74, 0x75, 0x73, 0x65, 0x72, 0x73, 0x65, 0x63,
	0x75, 0x72, 0x69, 0x74, 0x79,
}
...
func file_Qot_GetUserSecurity_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_Qot_GetUserSecurity_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*C2S); i {
			case 0:
				return &v.state
			case 1:
		...
		file_Qot_GetUserSecurity_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*S2C); i {
			case 0:
				return &v.state
			case 1:
		...
		file_Qot_GetUserSecurity_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_Qot_GetUserSecurity_proto_msgTypes[3].Exporter = func(v any, i int) any {
