...
var file_Qot_SetPriceReminder_proto_rawDesc = []byte{
	...
	0x5f, 0x44, 0x65, 0x6c, 0x41, 0x6c, 0x6c, 0x10, 0x06, 0x42, 0x4e, 0x0a, 0x13, 0x63, 0x6f, 0x6d,
	...
	0x70, 0x69, 0x2f, 0x70, 0x62, 0x2f, 0x71, 0x6f, 0x74, 0x73, 0x65, 0x74, 0x70, 0x72, 0x69, 0x63,
	0x65, 0x72, 0x65, 0x6d, 0x69, 0x6e, 0x64, 0x65, 0x72,
}
...
func file_Qot_SetPriceReminder_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_Qot_SetPriceReminder_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*C2S); i {
			case 0:
				return &v.state
			case 1:
		...
		file_Qot_SetPriceReminder_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*S2C); i {
			case 0:
				return &v.state
			case 1:
		...
		file_Qot_SetPriceReminder_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_Qot_SetPriceReminder_proto_msgTypes[3].Exporter = func(v any, i int) any {
